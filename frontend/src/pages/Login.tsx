        ...
        <Card className="bg-gray-800/40 backdrop-blur-md border-gray-700">
          ...
          <CardContent>
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700 text-white text-lg py-6" disabled={isLoading}>
                {isLoading ? (
                  <>
          ...
          <CardFooter>
            <p className="text-sm text-gray-400 text-center w-full">
              ...
              <a href="#" className="text-purple-400 hover:text-purple-300 underline underline-offset-4">Sign Up</a>
            </p>
          </CardFooter>
        </Card>
      </motion.div>
